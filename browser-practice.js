...
setTimeout(() => {
    console.log('output after 3.5 sec')
}, 3500);
...
/* const getInput = prompt('Give any number');
const inputToNumber = parseFloat(getInput);
const result = inputToNumber + 200;
alert(result); */
...
/* const getOpinion = confirm('do you want to see this website href');
if(getOpinion){
